...
class SociFusionAgent implements Agent, Conversational, HasTools
{
    ...
    public function instructions(): Stringable|string
    {
        ...
        return str_replace('{employee_name}', $name, $template)
            ...
            ."\n1. FIND / GET / SAVE prospects (\"get me 20 clients\", \"find leads\") → discover_prospects ONLY. Search, save to Leads, return samples. Do NOT draft_campaign_plan, propose_strategy, or launch outreach unless they explicitly ask to message/market/outreach."
            ...
            ."\n- Unified discovery → discover_prospects with target_count (auto-searches LinkedIn + Instagram when both connected; creates separate lists — stage one campaign per channel)"
