...
class SociFusionAgent implements Agent, Conversational, HasTools
{
    ...
    public function instructions(): Stringable|string
    {
        ...
        return str_replace('{employee_name}', $name, $template)
            ...
            ."\n2. discover_prospects — when user wants NEW / fetch / N prospects: ALWAYS pass target_count (and prefer_fresh if needed). That fetches LinkedIn, SAVES a list, returns list_hash. Never reuse engagers/old lists unless the user names that list. Without target_count: may use a strong-matching saved list"
