                    ...
                    <ul class="flex gap-3 text-sm leading-normal">
                        <li>
                            <a
                                ...
                                target="_blank"
                                class="inline-block rounded-sm border border-blue-600 bg-primary px-5 py-1.5 text-sm leading-normal text-primary-foreground hover:border-blue-700 hover:bg-blue-600"
                            >
                                Deploy now
                            </a>
                        </li>
