...
import { Layers, Megaphone, Pause, Play, Plus, Trash2 } from '@lucide/vue';
import { ref } from 'vue';
    ...
    <div class="flex flex-col gap-5 p-4">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="text-sm text-muted-foreground">Run LinkedIn, email, and messaging sequences via Unipile — separate from extension campaigns.</p>
            </div>
        ...
        <div v-else-if="campaigns.data.length === 0" class="flex flex-col items-center gap-4 rounded-xl border border-dashed p-14 text-center">
