...
<template>
    <div class="pointer-events-auto relative z-20" @click.stop>
        <button
            type="button"
        ...
        <div
            v-if="isOpen"
            class="absolute top-full z-50 mt-1.5 w-56 rounded-xl border border-slate-200 bg-white p-2 shadow-[0_16px_40px_rgba(15,23,42,0.14)]"
            :class="alignClass"
        >
