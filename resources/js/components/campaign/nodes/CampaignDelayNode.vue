...
<template>
    ...
    <div
        class="group relative flex min-w-[220px] cursor-pointer items-center gap-3 rounded-2xl border border-amber-200/80 bg-gradient-to-r from-amber-50 to-orange-50 px-4 py-3 shadow-[0_6px_18px_rgba(245,158,11,0.12)] transition-all hover:shadow-[0_10px_24px_rgba(245,158,11,0.16)]"
